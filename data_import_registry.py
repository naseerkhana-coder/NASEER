...
IMPORT_MODULE_CATALOG: list[ImportModuleInfo] = [
    ImportModuleInfo("boq", "BOQ Line Items", "BOQ",
                     ...
                     True, True, "boq"),
    ImportModuleInfo("boq_library", "Standard BOQ Library", "Master Libraries",
                     "Bulk import reusable BOQ catalogue items.", True, False, "boq_library"),
    ImportModuleInfo("wbs_library", "Standard WBS Library", "Master Libraries",
                     "Import WBS template hierarchy.", True, False, "wbs_library"),
    ImportModuleInfo("labour_library", "Labour Library", "Master Libraries",
                     "Import labour trade rates.", True, False, "labour_library"),
    ImportModuleInfo("machinery_library", "Machinery Library", "Master Libraries",
                     "Import equipment / machinery rates.", True, False, "machinery_library"),
    ImportModuleInfo("productivity_library", "Productivity Library", "Master Libraries",
                     "Import productivity norms by trade.", True, False, "productivity_library"),
    ImportModuleInfo("rate_library", "Rate Library", "Master Libraries",
                     "Import composite rate analysis by BOQ code.", True, False, "rate_library"),
    ...
    ImportModuleInfo("materials", "Material Library", "Master Libraries",
                     "Import material master (also on Store → Materials).", True, False, "materials"),
