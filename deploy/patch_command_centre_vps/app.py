...
def inject_maxek_layout():
    ...
    return {
        ...
        "hide_module_nav": request.endpoint in ("dashboard", "dashboard_choice_b", "department_portal"),
...
def render_choice_b_dashboard():
    ...
    return render_template(
        ...
        command_sidebar_items=get_command_centre_sidebar_items(db),
        command_centre_kpis=get_command_centre_kpis(db),
        command_centre_cards=get_command_centre_cards(db),
        command_centre_activity=get_command_centre_recent_activity(db),
